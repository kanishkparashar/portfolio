...
const Hero = () => {
  ...
  useEffect(() => {
    setText(roles[loopNum % roles.length])
    const timeout = setTimeout(() => setLoopNum((prev) => prev + 1), 2800)
    ...
    <section id="home" className="hero">
      ...
      <div className="hero-content">
        ...
        <h1 className="hero-name">
          <span className="name-highlight">Kanishk</span> <span className="name-dark">Parashar</span>
        </h1>
        ...
        <p className="hero-description">
          B.Tech CSE student passionate about building intelligent systems and exploring the intersection of
          <span className="highlight"> Data Science</span>,
          <span className="highlight"> Machine Learning</span>,
          <span className="highlight"> DevOps</span>, and
        ...
        <div className="hero-social">
          <a href="https://github.com/kanishkparashar" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="GitHub">
          ...
          <a href="https://linkedin.com/in/kanishk-parashar" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="LinkedIn">
            <svg viewBox="0 0 24 24" fill="currentColor" className="social-svg">
              <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
            </svg>
          </a>
          <a href="https://www.leetcode.com/kanishk4518" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="LeetCode">
            <svg viewBox="0 0 24 24" fill="currentColor" className="social-svg">
          ...
          <a href="https://www.hackerrank.com/kanishkparashar1" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="HackerRank">
            <svg viewBox="0 0 24 24" fill="currentColor" className="social-svg">
      ...
      <button className="scroll-indicator" onClick={scrollToAbout} type="button">
